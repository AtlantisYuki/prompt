...
3. **上下文**：设计前读取 `prd/`、适用的 `AGENTS.md`、现有实现和验证入口。可从仓库查到的事实必须自行查证。
...
- `scripts/install_codex_hook.ps1`
- `scripts/install_grok_hook.ps1`
- `scripts/hooks/codex_session_start.ps1`
- `scripts/hooks/cc_session_start.ps1`
- `scripts/hooks/grok_session_start.ps1`
